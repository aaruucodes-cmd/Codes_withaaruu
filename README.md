...
<!-- Music -->
<audio id="bgm" loop>
  <!-- Graceful fallback: no src, plays silence if no file -->
</audio>
...
// ════════════════════════════════════════════
//  THREE.JS BACKGROUND — petals + particles
// ════════════════════════════════════════════
(function initBG() {
  ...
  // Flowers (slightly larger, pink tinted)
